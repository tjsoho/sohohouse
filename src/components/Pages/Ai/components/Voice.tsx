  ...
  return (
    <div className="w-full h-full bg-brand-blue flex flex-col lg:flex-row py-16 md:py-32 lg:py-16 px-4 md:p-8 ">
      <div className="h-2/5 lg:h-full w-full lg:w-1/2 flex flex-col justify-center items-center text-left md:text-center mb-16 lg:pr-16">
        <h3 className="text-brand-orange leading-[40px] text-[32px] md:text-[60px] md:leading-tight text-left md:text-center w-full lg:px-1">Ready to elevate</h3>
      ...
      <div className="bg-brand-cream h-3/5 lg:h-full w-full lg:w-1/2 flex flex-col justify-center items-center">
        <p className="text-brand-blue p-8">
