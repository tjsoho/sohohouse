...
function Voice() {
  return (
    ...
    <div className="h-full bg-brand-blue flex flex-col lg:flex-row py-16 md:py-32 lg:py-16 px-4 md:p-8 ">
      <div className="h-2/5 lg:h-full w-full lg:w-1/2 flex flex-col justify-center items-center text-left md:text-center mb-16 lg:pr-16">
        <h3 className="text-brand-orange leading-[40px] text-[30px] md:text-[50px] md:leading-tight text-left md:text-center w-full pl-4 lg:p-0 lg:px-1">Ready to elevate</h3>
        <h3 className="text-brand-orange leading-[40px] text-[30px] md:text-[50px] md:leading-tight text-left md:text-center w-full pl-4 lg:p-0 lg:px-1">your brand's voice?</h3>
      </div>

      <div className=" h-3/5 lg:h-full w-full lg:w-1/2 flex flex-col justify-center items-center">
        <SlideReveal>
        <p className="text-brand-camel px-4 text-[18px] md:text-[20px]">
