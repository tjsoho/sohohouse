...
import mobIMG from '../assets/images/heroSM.png';
import tabIMG from '../assets/images/heroMD.png';
import deskIMG from '../assets/images/heroLG.png';

type HeaderResponsiveProps = {
  children: ReactNode;
};

function HeaderResponsive({ children }: HeaderResponsiveProps) {
