...
function Stories() {
  ...
  return (
    ...
    <div className="bg-brand-orange w-full h-full py-16 lg:py-20">
      ...
      <div>
        <p className="uppercase text-brand-blue italic text-center text-2xl md:text-3xl lg:text-5xl lg:text-end  lg:pr-[86px] 1xl:pr-[100px] 2xl:pr-[180px] mt-8 md:mt-0 leading-none font-medium lg:font-normal">
