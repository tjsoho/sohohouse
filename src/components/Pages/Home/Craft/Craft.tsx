...
function Craft() {
  ...
  return (
    <div className="bg-brand-orange w-full h-full py-12 md:py-16 lg:py-20">
      ...
      <div>
        <p className="uppercase text-brand-blue italic text-center text-2xl md:text-3xl lg:text-5xl lg:text-end md:pr-[10px] lg:pr-[146px] 1xl:pr-[120px] 2xl:pr-[200px] mt-8 md:mt-0 leading-none font-medium lg:font-normal">
          Discover What We Do
        </p>
